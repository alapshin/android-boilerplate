object Libraries {
    ...
    const val supporttestcore = "androidx.test:core:${Versions.androidxTest}"
    const val supporttesttruth = "androidx.test.ext:truth:1.0.0"
    const val supporttestrules = "androidx.test:rules:${Versions.androidxTest}"
    const val supporttestrunner = "androidx.test:runner:${Versions.androidxTest}"
    const val supporttestmonitor = "androidx.test:monitor:${Versions.androidxTest}"
