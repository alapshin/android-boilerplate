object Libraries {
    ...
    const val supporttestcore = "androidx.test:core:1.1.0"
    ...
    const val supporttestrunner = "androidx.test:runner:1.1.1"
    const val supporttestmonitor = "androidx.test:monitor:1.1.1"
